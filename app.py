...
st.info("Peramalan terintegrasi, analisis pasar, dan tata kelola model untuk prediksi ICP. Gunakan sidebar untuk menjelajahi dashboard, prediksi, tren, dan metrik model")
